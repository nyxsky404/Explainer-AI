          ...
          <div className="flex flex-col-reverse md:flex-row">
              ...
              <div className="flex-1 grow">
                <div className="border-t p-6 md:border-none">
                  <div className="flex items-center space-x-3">
                    <div
                      className="inline-flex shrink-0 items-center justify-center rounded-sm bg-muted p-3">
            ...
            <div className="flex-1 space-y-6 p-6 md:px-6 md:pb-8 md:pt-6">
              <div className="space-y-2">
                <div className="flex items-center space-x-3">
                  <div
                    className="inline-flex size-6 items-center justify-center rounded-sm bg-muted text-sm text-foreground">
                    1
                  </div>
                  <Label htmlFor="framework" className="text-sm font-medium text-foreground">
                    Select Framework
                  </Label>
                </div>
                <Select defaultValue="react">
                  <SelectTrigger id="framework" name="framework" className="w-full">
              ...
              <div className="space-y-2">
                <div className="flex items-center space-x-3">
                  ...
                  <Label htmlFor="package-manager" className="text-sm font-medium text-foreground">
                    Choose Package Manager
                  </Label>
                </div>
                <Select defaultValue="npm">
                  <SelectTrigger id="package-manager" name="package-manager" className="w-full">
              ...
              <div>
                <div className="flex items-center space-x-3">
                  ...
                  <Label htmlFor="linter" className="text-sm font-medium text-foreground">
                ...
                <Select defaultValue="eslint-prettier">
                  <SelectTrigger id="linter" name="linter" className="mt-4 w-full">
              ...
              <div>
                <div className="flex items-center space-x-3">
                  ...
                  <Label htmlFor="testing-tool" className="text-sm font-medium text-foreground">
                    Select Testing Tool
                  </Label>
                </div>
                <p className="mt-1 text-xs text-muted-foreground">
                ...
                <Select defaultValue="jest">
                  <SelectTrigger id="testing-tool" name="testing-tool" className="mt-4 w-full">
